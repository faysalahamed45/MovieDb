...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-netflix-background text-white">
      <form onSubmit={handleSubmit} className="bg-black p-6 rounded shadow w-full max-w-md">
